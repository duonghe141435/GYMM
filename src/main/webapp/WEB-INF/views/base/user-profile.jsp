...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/assets/css/profile-style.css'/>">
</head>
<body>
<header>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><img
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link text-dark" href="#">Lịch Tập</a></li>
                    <li class="nav-item"><a class="nav-link text-dark" href="#">Dịch Vụ</a></li>
