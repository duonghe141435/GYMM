...
<nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><img
            src="assets/img/brands/logo.png"></a><button data-bs-toggle="collapse" class="navbar-toggler"
                    ...
                    <div class="nav-item dropdown no-arrow">
                        <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown"
                           href="#">
                            ...
                            <img class="border rounded-circle img-profile" src="/assets/img/brands/hlv1.jpg" />
                        </a>
