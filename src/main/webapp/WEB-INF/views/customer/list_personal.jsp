...
<section class="wrapper">
                            ...
                            <c:if test="${tickets.tt_id == 2}">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="card" id="open_modal">
                                        <h4 class="tickets_id" style="display: none" aria-readonly="true">${tickets.t_id}</h4>
                                        <a class="img-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="card-read-more">
                                                <a onclick="handleOpenModal(this)" tid=${tickets.t_id} t_name="${tickets.t_name}" t_total_day=${tickets.t_total_days}
                                                        class="btn btn-link btn-block bookInTicket" type="button" data-bs-toggle="modal" data-bs-target="#trainerModal">
                                                    Mua vé ngay
                                                </a>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="py-5">
                                                                    <div class="container">
                                                                        ...
                                                                        <p hidden style="display: none" id="ticket_id"></p>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="row d-flex justify-content-center">
                                                                                <label class="form-label col-sm-2 mt-3" for="pt_name">Chọn HLV: ${trainerPersonal.u_full_name}</label>
                                                                                <div class="col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="row d-flex justify-content-center">
                                                                                <label class="form-label col-sm-2 mt-3" for="year">Số năm kinh nghiệm của PT:</label>
    ...
    <script>
        ...
        function handleOpenModal(event) {
            ...
            document.getElementById("ticket_id").innerText = event.getAttribute("tid");
        ...
        function handleBooking() {
            ...
            var ticket_pt_id = document.getElementById("ticket_id").textContent;
            Swal.fire('Bạn đã mua thành công', '', 'success');
            window.location.href = '<c:url value="/CustomerUser/saveTickerUser?" />' + "ticket_id=" + ticket_id + "&date=" + date + "&price=" + prices+ "&ticket_pt_id=" + ticket_pt_id;
        }

        $(document).ready(function () {
            $("#show-ticket-trainer").on('click', '.bookInTicket', function (){
                var ids = $(this).parent().siblings(".tickets_id").text();
                $.ajax(
                    {
                        type: "GET",
                        contentType: false,
                        url: "/customer/booking/checkEndDateTicketTrainerPersonal",
