                                                                ...
                                                                <c:forEach var="pageIndex" begin="1" end="${totalPages}">
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${isActive}">
                                                                            <li class="page-item active"><a class="page-link" href="<c:url value="/customer/activity-log/page=${pageIndex}" />">${pageIndex}</a></li>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <li class="page-item"><a class="page-link" href="<c:url value="/customer/activity-log/page=${pageIndex}" />">${pageIndex}</a></li>
                                                                        </c:otherwise>
                                                                    </c:choose>
