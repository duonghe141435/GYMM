                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid"
                            ...
                            <table class="table my-0" id="">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>luonghdhe141257@gmail.com</td>
                                    <td>0857298896</td>
                                    <td><a id="icon1" onclick="changeStatusLog(1)">
                                        <i class="fas fa-lock-open fa-lg fa-fw me-2 text-success">
                                        </i>
                                    </a>
                                    </td>
                                    ...
                                    <td>2008/11/28</td>
                                    <td>
                                        <a onclick="viewDetaillAccount(1)">
                                ...
                                <tr>
                                    ...
                                    <td>luonghdhe141257@gmail.com</td>
                                    <td>0857298896</td>
                                    <td><i class="fas fa-lock-open fa-lg fa-fw me-2 text-success"
                                           title="Khóa người dùng"></i></td>
                                    <td>Đã kích hoạt</td>
                                    <td>2008/11/28</td>
                                    <td>
                                        <i class="fas fa-eye fa-lg fa-fw me-2 text-primary"></i>
                                        <i class="fas fa-trash fa-lg fa-fw me-2 text-danger"></i>
                                    </td>
                                </tr>
