                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="left card" style="margin-left: 21px;border-radius: 35px; text-align: center;">
                                <ul id="myMenu">
                                    <li><c:url value="/admin/dashboard/activity-log" var="activityLogUrl">
                                            <c:param name="ids" value="${ids}" />
                                        </c:url>
                                        <a href="${activityLogUrl}"> <p class="text-primary m-0 fw-bold">Lịch sử hoạt động</p></a></li>
                                    <li><a href="<c:url value="/admin/dashboard/booking-ticket-log"/>"> <p class="text-primary m-0 fw-bold">Lịch sử đặt vé vào cửa</p></a></li>
                                    <li><a href="<c:url value="/admin/dashboard/booking-trainer-log"/>"> <p class="text-primary m-0 fw-bold">Lịch sử thuê huấn luyện viên</p></a></li>
                                    <li><a href="<c:url value="/admin/dashboard/booking-class-log"/>"> <p class="text-primary m-0 fw-bold">Lịch sử tham gia lớp học</p></a></li>
                                </ul>
                            </div>
                            <div class="right">
