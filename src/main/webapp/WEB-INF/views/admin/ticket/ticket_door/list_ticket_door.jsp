...
<div id="wrapper">
    <div class="d-flex flex-column" id="content-wrapper">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" style="max-height: 100vh;">
                            <table class="table my-0" id="ticket-door-table">
                                <thead>
                                <tr>
                                    ...
                                    <c:if test="${not empty tickets}"><c:forEach items="${tickets}" var="tickets">
                                        <tr>
                                            ...
                                            <td class="status text-center">
                                                ...
                                                <c:if test="${tickets.t_status == 0}"><span class="danger">Đã hủy</span></c:if>
                                            </td>
                                            <td class="text-center">${tickets.create_date}</td>
                                            <td class="text-center">
                                                <a class="ticket-view">
                                                    <i class="fas fa-eye fa-lg fa-fw me-2 text-info" title="Xóa chi tiết vé"></i></a>
        ...
        <%@include file="/WEB-INF/views/admin/ticket/ticket_door/modal_ticket_door.jsp"%>
