                    ...
                    <table class="table table-bordered"  id="dataTable1">
                        ...
                        <c:forEach var="tk" items="${listTicket}">
                            <tr style="text-align: center;">
                                ...
                                <td>Chai</td>
                                <td>
                                    Nước lọc mang theo khoáng chất thiết yếu, rất tốt cho việc tập luyện,
                                    cơ thể cần có ít nhất 2 lít nước mỗi ngày để duy trì sự khỏe mạnh.
                                </td>
                                <td>
                                ...
                                <form class="action=">
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-4" style="width: 130px;" for="nameOfProduct">Tên sản phẩm:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="nameOfProduct" name="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" min="0" class="form-control" id="price" name="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-2" style="width: 130px;" for="quantity">Số lượng:</label>
                                            <div class="col-sm-6">
                                                <input type="number" min="1" max="365"  class="form-control" id="quantity" name="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-2" style="width: 130px;" for="originalPrice">Giá nhập:</label>
                                            <div class="col-sm-6">
                                                <input type="number" min="0" class="form-control" id="originalPrice" name="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-2" style="width: 130px;" for="unit">Đơn vị:</label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-2" style="width: 130px;" for="description">Mô tả sản phẩm:</label>
                                            <div class="col-sm-6">
                                        <textarea name="txtComment" class="d-flex justify-content-start" style="padding-top: 0px ;width: 240px; font-family: 'Courier New', Courier, monospace;" readonly id="description" rows="5" cols="20">
                                        </textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="py-5">
                            <div class="container">
                                ...
                                <form class="action=">
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-4" style="width: 130px;" for="name">Tên:</label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-2" style="width: 130px;" for="price1">Giá bán:</label>
                                            <div class="col-sm-6">
                                                <input type="number" min="0" class="form-control" id="price1" name="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex justify-content-center">
                                            <label class="form-label col-sm-2" style="width: 130px;" for="quantity1">Số lượng:</label>
                                            <div class="col-sm-6">
                                                <input type="number" min="1" max="365"  class="form-control" id="quantity1" name="">
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row d-flex justify-content-center">
                            <label class="form-label col-sm-2" style="width: 130px;" for="typeofprice">Tên đơn vị:</label>
                            <div class="col-sm-6">
                                <input type="text" min="0" class="form-control" id="typeofprice" name="">
                            </div>
                        </div>
                    </div>
                </div>
