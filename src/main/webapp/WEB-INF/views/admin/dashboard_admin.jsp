    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                <li class="nav-item"><a class="nav-link active" href="<c:url value='/admin/dashboard'/>">
                    ...
                    <ul class="navbar-nav flex-nowrap ms-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">7</span><i class="fas fa-envelope fa-fw"></i></a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                    <h6 class="dropdown-header">alerts center</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="<c:url value='/assets/img/avatars/avatar4.jpeg'/> ">
                                    ...
                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="<c:url value='/assets/img/avatars/avatar2.jpeg'/>">
                                    ...
                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="<c:url value='/assets/img/avatars/avatar3.jpeg'/>">
                                    ...
                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="<c:url value='/assets/img/avatars/avatar5.jpeg'/>">
                                        <div class="bg-success status-indicator"></div>
                                    </div>
                                    <div class="fw-bold">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" src="<c:url value='/assets/img/avatars/avatar1.jpeg' />"></a>
