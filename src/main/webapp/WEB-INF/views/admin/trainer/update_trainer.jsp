            ...
            <div class="container-fluid" style="padding-top: 100px">
                <div class="card shadow">
                    <div class="card-header py-3" style="display: flex;">
                        <p class="text-primary m-0 fw-bold">Cập nhập thông tin HLV</p>
                    </div>
                    <div class="card-body"><c:url value="/admin/trainer/update-trainer?${_csrf.parameterName}=${_csrf.token}" var="updateUserUrl"/>
