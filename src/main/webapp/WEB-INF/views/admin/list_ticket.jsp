...
<div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        ...
        <div class="modal fade bd-example-modal-lg" id="addeModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="py-5">
                        <div class="container">
                            <p class="text-dark h2 text-center">Tạo vé tập mới</p>
                            <form:form id="addNewTicketForm" method="POST" action="/admin/dashboard/tickets/create" modelAttribute="ticket">
                                ...
                                <div class="form-group">
                                    <div class="row d-flex justify-content-center">
                                        <button style="width: 200px;" id="btnTickets" class="btn btn-primary btn-block mt-5">Thêm mới</button>
                                    </div>
                                </div>
