...
<nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top fixed-top">
    <div class="container-fluid" style="display: contents">
        <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href='<c:url value="/home"/>' style="padding: 0 .75rem;background-color: seagreen">
