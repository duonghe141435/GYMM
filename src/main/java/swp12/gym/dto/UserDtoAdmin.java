...
public class UserDtoAdmin {
        ...
        public UserDtoAdmin(int u_id, String u_full_name, String u_email, String u_password, String u_dob, int u_gender, String u_phone_number,
                       String u_address, String u_img, String u_identity_card,
                       int r_id, int u_enable, String u_create_date) {
            this.u_id = u_id;
        ...
        public int getU_enable() {
            return u_enable;
        }

        public void setU_enable(int u_enable) {
            this.u_enable = u_enable;
        }
